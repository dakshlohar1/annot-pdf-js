...
export class WriterUtil {
  ...
  public static readonly ENCRYPT: number[] = [
    47, 69, 110, 99, 114, 121, 112, 116,
  ];
  ...
  public static readonly MMTYPE1: number[] = [
    47, 77, 77, 84, 121, 112, 101, 49,
  ]; // /MMType1
  public static readonly TRUETYPE: number[] = [
    47, 84, 114, 117, 101, 84, 121, 112, 101,
  ]; // /TrueType
  public static readonly CIDFONTTYPE0: number[] = [
    47, 67, 73, 68, 70, 111, 110, 116, 84, 121, 112, 101, 48,
  ]; // /CIDFontType0
  public static readonly CIDFONTTYPE2: number[] = [
    47, 67, 73, 68, 70, 111, 110, 116, 84, 121, 112, 101, 50,
  ]; // /CIDFontType2
  public static readonly TYPE_ANNOT: number[] = [
    47,
    84,
    121,
    112,
  ...
  public static readonly TYPE_XOBJECT: number[] = [
    47,
    84,
    121,
    112,
  ...
  public static readonly TYPE_EXTGSTATE: number[] = [
    47,
    84,
    121,
    112,
  ...
  public static readonly TYPE_FONTDESCRIPTOR: number[] = [
    47,
    84,
    121,
    112,
  ...
  public static readonly TYPE_FONT: number[] = [
    47,
    84,
    121,
    112,
  ...
  public static readonly FONTNAME: number[] = [
    47, 70, 111, 110, 116, 78, 97, 109, 101,
  ]; // = '/FontName'
  public static readonly FONTFAMILY: number[] = [
    47, 70, 111, 110, 116, 70, 97, 109, 105, 108, 121,
  ]; // = '/FontFamily'
  public static readonly FONTSTRETCH: number[] = [
    47, 70, 111, 110, 116, 83, 116, 114, 101, 116, 99, 104,
  ]; // = '/FontStretch'
  public static readonly FLAGS: number[] = [47, 70, 108, 97, 103, 115]; // = '/Flags'
  public static readonly FONTBBOX: number[] = [
    47, 70, 111, 110, 116, 66, 66, 111, 120,
  ]; // = '/FontBBox'
  public static readonly ITALICANGLE: number[] = [
    47, 73, 116, 97, 108, 105, 99, 65, 110, 103, 108, 101,
  ]; // = '/ItalicAngle'
  public static readonly ASCENT: number[] = [47, 65, 115, 99, 101, 110, 116]; // = '/Ascent'
  public static readonly DESCENT: number[] = [
    47, 68, 101, 115, 99, 101, 110, 116,
  ]; // = '/Descent'
  public static readonly LEADING: number[] = [
    47, 76, 101, 97, 100, 105, 110, 103,
  ]; // = '/Leading'
  public static readonly CAPHEIGHT: number[] = [
    47, 67, 97, 112, 72, 101, 105, 103, 104, 116,
  ]; // = '/CapHeight'
  public static readonly XHEIGHT: number[] = [
    47, 88, 72, 101, 105, 103, 104, 116,
  ]; // = '/XHeight'
  public static readonly STEMV: number[] = [47, 83, 116, 101, 109, 86]; // = '/StemV'
  public static readonly ENCODING: number[] = [
    47, 69, 110, 99, 111, 100, 105, 110, 103,
  ]; // = '/Encoding'
  public static readonly STEMH: number[] = [47, 83, 116, 101, 109, 2]; // = '/StemH'
  public static readonly AVGWIDTH: number[] = [
    47, 65, 118, 103, 87, 105, 100, 116, 104,
  ]; // = '/AvgWidth'
  public static readonly MAXWIDTH: number[] = [
    47, 77, 97, 120, 87, 105, 100, 116, 104,
  ]; // = '/MaxWidth'
  public static readonly MISSINGWIDTH: number[] = [
    47, 77, 105, 115, 115, 105, 110, 103, 87, 105, 100, 116, 104,
  ]; // = '/MissingWidth'
  public static readonly FIRSTCHAR: number[] = [
    47, 70, 105, 114, 115, 116, 67, 104, 97, 114,
  ]; // = '/FirstChar'
  public static readonly LASTCHAR: number[] = [
    47, 76, 97, 115, 116, 67, 104, 97, 114,
  ]; // = '/LastChar'
  public static readonly BASEFONT: number[] = [
    47, 66, 97, 115, 101, 70, 111, 110, 116,
  ]; // = '/BaseFont'
  public static readonly WIDTHS: number[] = [47, 87, 105, 100, 116, 104, 115]; // = '/Widths'
  public static readonly FONTDESCRIPTOR: number[] = [
    47, 70, 111, 110, 116, 68, 101, 115, 99, 114, 105, 112, 116, 111, 114,
  ]; // = '/FontDescriptor'
  public static readonly XOBJECT: number[] = [
    47, 88, 79, 98, 106, 101, 99, 116,
  ]; // = '/XObject'
  public static readonly EXTGSTATE: number[] = [
    47, 69, 120, 116, 71, 83, 116, 97, 116, 101,
  ]; // = '/ExtGState'
  public static readonly COLORSPACE: number[] = [
    47, 67, 111, 108, 111, 114, 83, 112, 97, 99, 101,
  ]; // = '/ColorSpace'
  public static readonly PATTERN: number[] = [
    47, 80, 97, 116, 116, 101, 114, 110,
  ]; // = '/Pattern'
  public static readonly SHADING: number[] = [
    47, 83, 104, 97, 100, 105, 110, 103,
  ]; // = '/Shading'
  public static readonly FONT: number[] = [47, 70, 111, 110, 116]; // = '/Font'
  public static readonly PROCSET: number[] = [
    47, 80, 114, 111, 99, 83, 101, 116,
  ]; // = '/ProcSet'
  public static readonly PROPERTIES: number[] = [
    47, 80, 114, 111, 112, 101, 114, 116, 105, 101, 115,
  ]; // = '/Properties'
  public static readonly RECT: number[] = [47, 82, 101, 99, 116];
  public static readonly RESOURCES: number[] = [
    47, 82, 101, 115, 111, 117, 114, 99, 101, 115,
  ]; // = '/Resources'
  public static readonly SUBTYPE: number[] = [
    47, 83, 117, 98, 116, 121, 112, 101,
  ];
  ...
  public static readonly CONTENTS: number[] = [
  ...
  public static readonly STATEMODEL: number[] = [
    47, 83, 116, 97, 116, 101, 77, 111, 100, 101, 108,
  ]; // = '/StateModel'
  ...
  public static readonly INKLIST: number[] = [
    47, 73, 110, 107, 76, 105, 115, 116,
  ]; // = '/InkList'
  public static readonly FILTER: number[] = [47, 70, 105, 108, 116, 101, 114]; // = '/Filter'
  public static readonly FLATEDECODE: number[] = [
    47, 70, 108, 97, 116, 101, 68, 101, 99, 111, 100, 101,
  ]; // = '/FlateDecode'
  ...
  public static readonly ENDSTREAM: number[] = [
    101, 110, 100, 115, 116, 114, 101, 97, 109,
  ]; // = 'endstream'
  public static readonly FORMTYPE: number[] = [
    47, 70, 111, 114, 109, 84, 121, 112, 101,
  ]; // = '/FormType'
  ...
  public static readonly CREATION_DATE: number[] = [
    47, 67, 114, 101, 97, 116, 105, 111, 110, 68, 97, 116, 101,
  ]; // = '/CreationDate'
  ...
  public static readonly STARTXREF: number[] = [
  ...
  public static readonly QUADPOINTS: number[] = [
    47, 81, 117, 97, 100, 80, 111, 105, 110, 116, 115,
  ]; // = '/QuadPoints'
  public static readonly VERTICES: number[] = [
    47, 86, 101, 114, 116, 105, 99, 101, 115,
  ]; // = '/Vertices'
  public static readonly NAME: number[] = [47, 78, 97, 109, 101]; // = '/Name'
  public static readonly DRAFT: number[] = [47, 68, 114, 97, 102, 116]; // = '/Draft'
  public static readonly LINE: number[] = [47, 76]; // = '/L'
   ...
   * */
  public static writeReferencePointer(
   ...
   * */
  public static replaceAnnotsFieldInPageObject(
    data: Uint8Array,
    page: Page,
    page_ptr: number,
    annot_array_reference: ReferencePointer
  ): number[] {
    let ptr_objend = Util.locateSequence(Util.ENDOBJ, data, page_ptr, true);

    let complete_page_object_data = data.slice(
      page_ptr,
      ptr_objend + Util.ENDOBJ.length
    );
    ...
    if (page.hasAnnotsField) {
      ...
      let ptr_annots = Util.locateSequence(
        Util.ANNOTS,
        complete_page_object_data,
        0,
        true
      );

      ret = Array.from(
        complete_page_object_data.slice(0, ptr_annots + Util.ANNOTS.length)
      );
      ret.push(Util.SPACE);
      ret = ret.concat(
        WriterUtil.writeReferencePointer(annot_array_reference, true)
      );
      ret.push(Util.SPACE);
      let ptr_annots_array_end =
        Util.locateSequence(
          Util.ARRAY_END,
          complete_page_object_data,
          ptr_annots,
          true
        ) + Util.ARRAY_END.length;

      ret = ret.concat(
        Array.from(
          complete_page_object_data.slice(
            ptr_annots_array_end,
            complete_page_object_data.length
          )
        )
      );
    } else {
      let ptr_dict_end = Util.locateSequenceReversed(
        Util.DICT_END,
        complete_page_object_data,
        complete_page_object_data.length - 1
      );

      if (-1 === ptr_dict_end) throw Error("Could not identify dictionary end");
   ...
   * */
  public static writeStreamObject(
    object_id: ReferencePointer,
    dict: number[],
    ...
    ret.push(WriterUtil.SPACE);
    ret = ret.concat(
      Util.convertNumberToCharArray((streamData as number[]).length)
    );
    ret.push(WriterUtil.SPACE);
